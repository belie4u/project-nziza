...
is_elasticsearch_supported = get_class(
    "search.features", "is_elasticsearch_supported")
...
class SolrProductSearchHandler(SearchHandler):
    ...
    def __init__(self, request_data, full_path, categories=None, products_per_page=None ):
        self.categories = categories
        self.paginate_by = products_per_page or settings.OSCAR_PRODUCTS_PER_PAGE
